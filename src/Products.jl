...
"""
function locate(lp::LibraryProduct, prefix::Prefix; platform::Platform = HostPlatform(),
...
function locate(fp::FrameworkProduct, prefix::Prefix; platform::Platform = HostPlatform(), verbose::Bool = false, kwargs...)
...
"""
function locate(ep::ExecutableProduct, prefix::Prefix; platform::Platform = HostPlatform(),
...
"""
function locate(fp::FileProduct, prefix::Prefix; platform::Platform = HostPlatform(),
                verbose::Bool = false, isolate::Bool = false, kwargs...)
