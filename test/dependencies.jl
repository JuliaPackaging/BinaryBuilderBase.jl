...
@testset "Dependencies" begin
    ...
    @testset "Setup" begin
        ...
        mktempdir() do dir
            ...
            @test_logs (:warn, "Dependency LibOSXUnwind_jll does not have a mapping for artifact LibOSXUnwind; perhaps it was not built for platform Linux(:i686, libc=:musl)") setup_dependencies(prefix, getpkg.(dependencies), platform)
